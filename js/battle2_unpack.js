...
{
	if(!target)urlq='battle2.php?use_magic='+what;
	else urlq='battle2.php?use_magic='+what+'&target='+target;
...
update_hp=function()
{
	...
	function(data)
	{
        ...
        {
           $.get( "battle2.php", {'act':'load_enemy'}, function(z){ $('#enemy').html(z);   } );
...
blocks=function()
{
	...
	$("input[name=block1]:checked").each(function(id)
	{
...
$(window).unload($("#battle_status").load("ajax/battle2_check.php",{'act':'check'}));