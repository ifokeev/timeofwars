	...
	<tr bgcolor="<?=$color;?>">
	 <td width="100px" valign="bottom">
	  <table width="100%">
	   ...
	   <tr>
	    <td><a href="?wear=<?=$v['Un_Id'];?>&part=<?=$part;?>"><img src="http://<?=$db_config[DREAM_IMAGES][server];?>/adm/use.gif" title="Одеть Вещь" /></a></td>
...
<table width="100%" bgcolor="#999999">
 <tr>
  <td colspan="5" align="center">
   <a href="?undress=all&part=<?=$part;?>">Cнять все</a> |
   <a href="?complect=save&part=<?=$part;?>">Сохранить комплект</a> |
   <a href="?complect=load&part=<?=$part;?>">Одеть комплект</a>
  </td>
 </tr>
</table>
