...
$query = sprintf("DELETE crr FROM ".SQL_PREFIX."clan_ranks_has_admin_rules crr LEFT JOIN ".SQL_PREFIX."clan_ranks cr ON( cr.id_rank = crr.id_rank ) WHERE cr.id_clan = '%d' AND cr.id_rank = '%d';", $id_clan, $id_rank );
